...
def chat():
    ...
    try:
        ...
        if not api_key:
            ...
            return jsonify({
                'response': f"Hello! I'm {config['agent_name']}, your {config['brand_name']} support assistant. How can I help you today? (Note: Please set your OPENAI_API_KEY in .env file to enable AI responses)"
            })
